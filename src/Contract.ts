...
const {
  logDecoder,
} = require("recryptjs-ethjs-abi") as IETHABI
...
export class Contract {
   ...
   *      [solar](https://github.com/recryptproject/solar). It includes the contract
   *      address, owner address, and ABI definition for methods and types.
   * @param opts - init options
   */
  constructor(private rpc: RecryptRPC, public info: IContractInfo, opts: IContractInitOptions = {}) {
  ...
  /**
   * Executes contract method on your own local recryptd node as a "simulation"
